...
class BreathActivity : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val breathing = findViewById<TextView>(R.id.breathingInstructions)
        val startButton = findViewById<TextView>(R.id.startButton)


        // 初始畫面
        breathing.text = "深呼吸練習\n\n請坐在一個舒適的位置，閉上眼睛。"
        ...
        startButton.setOnClickListener {
            ...
            val breathingTimer = object : CountDownTimer(60000, 5000) {
                ...
                //計時器會每5秒在畫面中顯示“深吸氣”或“深呼氣”，共進行6個循環，總計60秒，然後顯示“深呼吸練習完成！”。
